    ...
    return (
        ...
        <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="flex justify-center md:justify-start pt-12 md:pl-12 md:-mb-24">
                <a href="#" className="bg-black text-white font-bold text-xl p-4">Code Kahoot</a>
            </div>
        ...
        <div className="w-1/2 shadow-2xl">
            <img className="object-cover w-full h-screen hidden md:block" src="https://source.unsplash.com/IXUM4cJynP0" alt="abstract banner" />
        </div>
    </div>
    )
}
